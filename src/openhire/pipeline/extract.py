...
class HeuristicExtractor:
    ...
    def extract(self, job: JobRecord) -> ExtractionResult:
        ...
        # Vocabulary tags need a JD to be read from. Remote policy and salary below are
        # already sourced from the ATS fields first and the JD second, never the title.
