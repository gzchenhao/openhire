...
[`openhire-0.6.5.mcpb`](https://github.com/gzchenhao/openhire/releases/latest) and
...
> **Claude Desktop** — download [`openhire-0.6.5.mcpb`](https://github.com/gzchenhao/openhire/releases/latest)
...
matters: `"args": ["openhire==0.6.5", "serve"]`.
