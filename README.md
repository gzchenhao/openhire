...
[`openhire-0.6.3.mcpb`](https://github.com/gzchenhao/openhire/releases/latest) and
...
> **Claude Desktop** — download [`openhire-0.6.3.mcpb`](https://github.com/gzchenhao/openhire/releases/latest)
...
matters: `"args": ["openhire==0.6.3", "serve"]`.
