...
[`openhire-0.6.2.mcpb`](https://github.com/gzchenhao/openhire/releases/latest) and
...
> **Claude Desktop** — download [`openhire-0.6.2.mcpb`](https://github.com/gzchenhao/openhire/releases/latest)
...
matters: `"args": ["openhire==0.6.2", "serve"]`.
